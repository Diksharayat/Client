...
// const Login = () => {
// //here we call the useContext as a function call and should be inside the component.
// //it require only one argument that is the instance of create context. 
// //this state represent the value inside our provider
// const {loginUserAction,userAuth}=useContext(authContext)
// // like this we can have access to isLogin inside the login component.
// //  console.log(state);
// // 
